...
const Denombremement = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "box content", children: [
    /* @__PURE__ */ jsxs("h4", { className: "title is-5", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "field", children: /* @__PURE__ */ jsx("div", { className: "control", children: exercice.propositions.map((item, index) => /* @__PURE__ */ jsxs("label", { className: "radio", style: { display: "flex", alignItems: "center", marginBottom: "10px" }, children: [
      /* @__PURE__ */ jsx(
        "input",
        {
          type: "radio",
      ...
      /* @__PURE__ */ jsx("span", { className: "ml-2", children: /* @__PURE__ */ jsx(MathTex, { tex: item.tex }) })
    ] }, index)) }) }),
    /* @__PURE__ */ jsxs("div", { className: "field is-grouped", children: [
      /* @__PURE__ */ jsx("div", { className: "control", children: /* @__PURE__ */ jsx("button", { className: "button is-primary", onClick: handleValidate, disabled: checked === null, children: "Valider" }) }),
    ...
    validated && checked !== null && /* @__PURE__ */ jsxs("div", { className: `notification ${exercice.propositions[checked].correct ? "is-success" : "is-danger"} is-light mt-4`, children: [
      /* @__PURE__ */ jsx("button", { className: "delete", onClick: () => setValidated(false) }),
